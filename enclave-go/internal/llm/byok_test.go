...
func TestPerProviderNativeMaps(t *testing.T) {
	cases := []struct {
		...
		{"telnyx", "google/gemma-2b-it", "google/gemma-2b-it"},
		{"telnyx", "meta-llama/llama-3.3-70b-instruct", "meta-llama/Llama-3.3-70B-Instruct"},
		{"telnyx", "meta-llama/llama-3.1-70b-instruct", "meta-llama/Meta-Llama-3.1-70B-Instruct"},
		{"telnyx", "meta-llama/llama-3.1-8b-instruct", "meta-llama/Meta-Llama-3.1-8B-Instruct"},
		{"telnyx", "minimax/minimax-m2.7", "MiniMaxAI/MiniMax-M2.7"},
		{"telnyx", "minimax/minimax-m3", "MiniMaxAI/MiniMax-M3-MXFP8"},
		{"telnyx", "moonshotai/kimi-k2.5", "moonshotai/Kimi-K2.5"},
		{"telnyx", "moonshotai/kimi-k2.6", "moonshotai/Kimi-K2.6"},
		{"telnyx", "moonshotai/kimi-k3", "moonshotai/Kimi-K3"},
		{"telnyx", "qwen/qwen3-235b-a22b", "Qwen/Qwen3-235B-A22B"},
		...
		{"thinkingmachines", "z-ai/glm-5.3", "zai-org/GLM-5.3:peft:262144"},
...
func TestDirectModelIDResolvesMixedCaseUpstreamID(t *testing.T) {
	cases := []struct {
		...
		{"thinkingmachines", "z-ai/glm-5.3", "zai-org/GLM-5.3:peft:262144", "zai-org/GLM-5.3:peft:262144"},
