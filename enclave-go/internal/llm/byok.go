...
func providerUsesAuthorizedUpstreamModel(provider string) bool {
	switch provider {
	case "together", "lightning", "parasail", "deepinfra", "gmi", "tinfoil", "venice", "friendli", "baseten", "telnyx", "thinkingmachines", "wafer", "crusoe", "makora", "minimax", "siliconflow", "neurometric", "engy", "zero-g", "alibaba", "azure":
		return true
	default:
		return false
	}
