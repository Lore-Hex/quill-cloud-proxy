...
func New(boot *qtypes.BootstrapData) Client {
	return &multiClient{
		...
		inceptron:  newOpenAICompatible("inceptron", boot.InceptronAPIKey),
		...
		azure:   newAzure(boot.AzureAPIKey),
...
func (m *multiClient) InvokeStreaming(
	...
	case "inceptron":
		return m.inceptron.InvokeStreaming(ctx, req, body, out, options...)
	case "morph":
		return m.morph.InvokeStreaming(ctx, req, body, out, options...)
	case "atlas-cloud":
	...
	case "zero-g":
		return m.zeroG.InvokeStreaming(ctx, req, body, out, options...)
	case "alibaba":
		return m.alibaba.InvokeStreaming(ctx, req, body, out, options...)
	case "azure":
		return m.azure.InvokeStreaming(ctx, req, body, out, options...)
	case "xiaomi":
	...
	default:
		return fmt.Errorf("llm/multi: unsupported provider %q (compiled providers: anthropic, vertex, openai, meta, google-vertex, google-ai-studio, cerebras, deepseek, mistral, kimi, zai, together, fireworks, grok, novita, phala, siliconflow, tinfoil, venice, parasail, lightning, gmi, deepinfra, friendli, baseten, telnyx, thinkingmachines, wafer, crusoe, makora, nebius, minimax, chutes, digitalocean, cloudflare-workers-ai, inceptron, morph, atlas-cloud, streamlake, neurometric, engy, zero-g, alibaba, azure, xiaomi, cohere)", provider)
	}
}
