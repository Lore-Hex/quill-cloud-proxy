...
func TestMultiClientDispatchesPrepaidOpenAICompatibleProviders(t *testing.T) {
	tests := []struct {
		...
		{"openrouter", "stealth/union-alpha", "stealth/union-alpha", "stealth/union-alpha", false},
		{"openrouter", "stealth/union-alpha", "", "stealth/union-alpha", false},
		{"openrouter", "bytedance-seed/seed-2-1-turbo", "bytedance-seed/seed-2-1-turbo", "bytedance-seed/seed-2-1-turbo", false},
		{"openrouter-exclusive", "stealth/ox-alpha", "stealth/ox-alpha", "stealth/ox-alpha", false},
...
func TestBootstrapDirectProviderClientsAreBoundedToCompiledHosts(t *testing.T) {
	wantBaseURLs := map[string]string{
		...
		"confidential-ai": "https://api.confidential.ai/v1",
	...
	keys := map[string]string{
		...
		"wandb":           "key-wandb",
		"nscale":          "key-nscale",
		"confidential-ai": "key-confidential-ai",
