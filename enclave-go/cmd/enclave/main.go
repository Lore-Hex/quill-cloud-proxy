...
func serveOneRequest(
	...
	if isDecidePath(routePath) {
		...
		serveDecide(ctx, conn, br, body, trGateway, trEnabled, bearer, byokSecrets, idempotencyKey, attribution, requestLogID)
		return
	}
...
// applyCacheUsage copies provider-reported usage details into settlement. Most
