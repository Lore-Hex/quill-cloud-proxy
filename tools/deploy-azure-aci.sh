...
# These optional provider names default off. When an operator explicitly names
# one, azure-seal-bundle.py requires its cloud-local value before any container
# group mutation, so a partial provider rollout fails before serving traffic.
...
QUILL_WANDB_SECRET="${QUILL_WANDB_SECRET:-}"
QUILL_NSCALE_SECRET="${QUILL_NSCALE_SECRET:-}"
QUILL_REGOLO_SECRET="${QUILL_REGOLO_SECRET:-}"
QUILL_REDPILL_SECRET="${QUILL_REDPILL_SECRET:-}"
QUILL_META_DIRECT_SECRET="${QUILL_META_DIRECT_SECRET:-}"
QUILL_GENERAL_COMPUTE_SECRET="${QUILL_GENERAL_COMPUTE_SECRET:-}"
QUILL_INFOMANIAK_SECRET="${QUILL_INFOMANIAK_SECRET:-}"
QUILL_CONFIDENTIAL_AI_SECRET="${QUILL_CONFIDENTIAL_AI_SECRET:-trustedrouter-confidential-ai-api-key}"
QUILL_SCALEDOWN_SECRET="${QUILL_SCALEDOWN_SECRET:-trustedrouter-scaledown-api-key}"
QUILL_PERPLEXITY_SECRET="${QUILL_PERPLEXITY_SECRET:-}"
QUILL_KREA_SECRET="${QUILL_KREA_SECRET:-}"
QUILL_FAL_SECRET="${QUILL_FAL_SECRET:-}"
QUILL_BYTEPLUS_SECRET="${QUILL_BYTEPLUS_SECRET:-}"
QUILL_TENCENT_SECRET="${QUILL_TENCENT_SECRET:-}"
QUILL_VULTR_SECRET="${QUILL_VULTR_SECRET:-}"
QUILL_HUGGING_FACE_SECRET="${QUILL_HUGGING_FACE_SECRET:-}"
QUILL_VERCEL_AI_GATEWAY_SECRET="${QUILL_VERCEL_AI_GATEWAY_SECRET:-}"
QUILL_TYPESAFE_SECRET="${QUILL_TYPESAFE_SECRET:-}"
QUILL_DARKBLOOM_SECRET="${QUILL_DARKBLOOM_SECRET:-}"
QUILL_BAIDU_SECRET="${QUILL_BAIDU_SECRET:-}"
QUILL_RIVERFLOW_SECRET="${QUILL_RIVERFLOW_SECRET:-}"
...
for name in (
    ...
    "QUILL_ALIBABA_SECRET", "QUILL_AZURE_SECRET", "QUILL_ATLAS_CLOUD_SECRET", "QUILL_CHUTES_SECRET",
    ...
    "QUILL_STEPFUN_SECRET", "QUILL_RELACE_SECRET", "QUILL_DECART_SECRET",
    "QUILL_RECRAFT_SECRET", "QUILL_BFL_SECRET",
    "QUILL_NEXTBIT_SECRET", "QUILL_AION_LABS_SECRET", "QUILL_SAMBANOVA_SECRET",
    "QUILL_INCEPTION_SECRET", "QUILL_AKASHML_SECRET", "QUILL_ARCEE_SECRET",
    "QUILL_UPSTAGE_SECRET", "QUILL_REKA_SECRET", "QUILL_SAIL_RESEARCH_SECRET",
    "QUILL_MANCER_SECRET", "QUILL_IO_NET_SECRET", "QUILL_SCALEWAY_SECRET",
    "QUILL_FEATHERLESS_SECRET", "QUILL_JINA_SECRET", "QUILL_SAKANA_SECRET",
    "QUILL_NVIDIA_NIM_SECRET",
    "QUILL_WANDB_SECRET",
    "QUILL_NSCALE_SECRET",
    "QUILL_REGOLO_SECRET",
    "QUILL_REDPILL_SECRET",
    "QUILL_META_DIRECT_SECRET",
    "QUILL_GENERAL_COMPUTE_SECRET",
    "QUILL_INFOMANIAK_SECRET",
    "QUILL_CONFIDENTIAL_AI_SECRET",
    "QUILL_SCALEDOWN_SECRET",
    "QUILL_PERPLEXITY_SECRET", "QUILL_KREA_SECRET", "QUILL_FAL_SECRET",
    "QUILL_BYTEPLUS_SECRET", "QUILL_TENCENT_SECRET",
    "QUILL_VULTR_SECRET", "QUILL_HUGGING_FACE_SECRET", "QUILL_DARKBLOOM_SECRET",
    "QUILL_VERCEL_AI_GATEWAY_SECRET",
    "QUILL_TYPESAFE_SECRET",
    "QUILL_BAIDU_SECRET", "QUILL_RIVERFLOW_SECRET",
...
export MAA_ENDPOINT VAULT SKR_KEY BUNDLE_SECRET LOCATION API_HOST EXTRA_API_HOSTS \
  ...
  QUILL_SILICONFLOW_SECRET QUILL_TINFOIL_SECRET QUILL_NEAR_AI_SECRET QUILL_VENICE_SECRET \
