...
QUILL_CLOUDFLARE_WORKERS_AI_SECRET="${QUILL_CLOUDFLARE_WORKERS_AI_SECRET:-trustedrouter-cloudflare-workers-ai-api-key}"
...
QUILL_OPENAI_VIDEO_SECRET="${QUILL_OPENAI_VIDEO_SECRET:-trustedrouter-openai-video-api-key}"
...
for name in (
    ...
    "QUILL_CLOUDFLARE_WORKERS_AI_SECRET", "QUILL_DIGITALOCEAN_SECRET", "QUILL_ENGY_SECRET",
