...
configure_optional_provider_secret QUILL_PRIVATEMODE_SECRET trustedrouter-privatemode-api-key
...
configure_optional_provider_secret QUILL_TELLUVIAN_SECRET trustedrouter-telluvian-api-key
