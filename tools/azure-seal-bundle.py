...
BINDINGS: tuple[Binding, ...] = (
    ...
    Binding(("QUILL_STEPFUN_SECRET",), "stepfun key", True),
    Binding(("QUILL_RELACE_SECRET",), "relace key", True),
    Binding(("QUILL_DECART_SECRET",), "decart key", True),
    Binding(("QUILL_RECRAFT_SECRET",), "recraft key", True),
    Binding(("QUILL_BFL_SECRET",), "bfl key", True),
    ...
    # Resolved for cross-cloud parity but inert in Stage A: Azure does not set
    ...
    Binding(("QUILL_REDPILL_SECRET",), "Redpill key", True),
    Binding(("QUILL_META_DIRECT_SECRET",), "Meta direct key", True),
    Binding(("QUILL_GENERAL_COMPUTE_SECRET",), "General Compute key", True),
    Binding(("QUILL_INFOMANIAK_SECRET",), "Infomaniak key", True),
    ...
    Binding(("QUILL_FAL_SECRET",), "FAL key", True),
    Binding(("QUILL_BYTEPLUS_SECRET",), "BytePlus ModelArk key", True),
