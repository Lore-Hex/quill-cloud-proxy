...
def main() -> int:
    ...
    # Baseline: regions ALREADY 'down' before the deploy. These are
    # excluded from rollback accounting — the canary watchdog is
    # interested in whether the NEW image broke something, not
    # whether some unrelated upstream has been red all morning.
    # Mirrors the same fix in quill-router's
