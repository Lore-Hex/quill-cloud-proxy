...
Capture rollback points (all four GCP regions; us-west1 prints nothing before
its first deploy has created the MIG):

```bash
for pair in us:us-central1 useast4:us-east4 eu:europe-west4 uswest1:us-west1; do
